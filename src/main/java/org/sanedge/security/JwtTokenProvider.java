...
public class JwtTokenProvider implements TokenProvider {
    ...
    @Override
    public String createUserToken(String subject, ERole role) {
        ...
        builder.withArrayClaim(CLAIM_ROLES, toArrayNames(role));
    ...
    public String createRefreshToken(String subject, String audience) {
        JWTCreator.Builder builder;
    ...
    @Override
    public ERole[] extractRoles(DecodedJWT decodedJWT) {
        Claim claim = decodedJWT.getClaim(CLAIM_ROLES);
        return claim.asArray(ERole.class);
    }

    private static String[] toArrayNames(ERole... allowedRoles) {
